function start() { // Inicio da função start()
    ...
    function colisao() {
        ...
        //collision = função do Jquery collision
        //Checa colisão entre os dois elementos (divs)  
        ...
        if (colisao1.length > 0) {
            ...
            //pega coordenadas do inimigo
            inimigo1X = parseInt($("#inimigo1").css("left"));
            inimigo1Y = parseInt($("#inimigo1").css("top"));

            //Chama o metodo de explosão
